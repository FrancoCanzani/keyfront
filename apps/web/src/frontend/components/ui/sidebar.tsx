  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full min-w-0 flex-row overflow-hidden has-data-[variant=inset]:bg-sidebar",
          className,
        )}
        {...props}
      >
...
function Sidebar({
  ...
  const { collapsible, isMobile, state, openMobile, setOpenMobile } =
    useSidebar();
  ...
  if (collapsible === "none") {
    ...
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "hidden h-svh min-h-0 w-(--sidebar-width) shrink-0 flex-col bg-sidebar text-sidebar-foreground md:flex",
          className,
        )}
        {...props}
      >
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex min-h-0 min-w-0 w-full max-w-full flex-1 flex-col overflow-hidden bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className,
      )}
      {...props}
    />
